...
namespace Greyman{
	public class OffScreenIndicatorManagerVR : OffScreenIndicatorManager {
		...
		public override void AddIndicator(Transform target, int indicatorID, string indicatorColor){
			...
			if (!ExistsIndicator(target)){
				...
				if(indicatorColor == "Yellow"){
					newArrowIndicator.indicator.offScreenColor = Color.yellow;
					newArrowIndicator.indicator.onScreenColor = Color.yellow;
					newArrowIndicator.indicator.showOnScreen = true;
				} 
				else if (indicatorColor == "Red")
				{
					newArrowIndicator.indicator.offScreenColor = Color.red;
					newArrowIndicator.indicator.onScreenColor = Color.red;
					newArrowIndicator.indicator.showOnScreen = false;
				}
